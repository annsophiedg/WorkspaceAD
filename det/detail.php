...
<header>
    ...
    <section class="small flex">
        ...
        $sql = "select * from workshop
          ...
          where wor_id= ". max($_GET['id'], $_POST['signUp']);
        ...
        {   //als op de schrijfin-knop geklikt wordt:
            if(isset($_POST["signUp"])){
                ...
                print '<form action="detail.php" method="post">
                        <button id="h4" type="submit" name="signUp" value="'.$_GET["id"].'">Schrijf je in voor deze workshop!</button>
                       </form>';
            }
            ...
            print '<div id="schrijfinreg" class="schrijfin flex flexC">
                                ...
                                <form action="http://localhost/18.12/vrije_opdracht/reg/registreer.php" method="post">
